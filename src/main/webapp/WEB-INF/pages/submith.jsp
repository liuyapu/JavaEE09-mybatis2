...
<%@ page import="org.mybatis.class09.model.TeacherHomework" %>
...
<table align="center" width = "960" border="1"
    ...
    <form method="post" action="/submit/homework">
        <tr align="center" bgcolor="white" height = "30">
            ...
            <td><input name="homeworktitle" value="<%=sh.getTitle()%>" readonly="readonly"></td>
            <td><input name="homeworkcontent" type="text" value="<%=sh.getContent()%>"></td>
            <td><input name="homeworktime" type="text" value="<%=sh.getCreate_time()%>"></td>
